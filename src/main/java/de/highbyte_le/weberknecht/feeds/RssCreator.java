...
public class RssCreator implements FeedCreator {
	...
	/* (non-Javadoc)
	 * @see de.highbyte_le.weberknecht.feeds.FeedCreator#createFeed(de.highbyte_le.weberknecht.feeds.FeedData)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.highbyte_le.weberknecht.feeds.FeedCreator#getContentType()
	 */
	@Override
